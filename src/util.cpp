...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\XAB
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\XAB
    // Mac: ~/Library/Application Support/XAB
    // Unix: ~/.XAB
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "XAB";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "XAB.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "XABd.pid"));
