...
const string strMessageMagic = "XAB Signed Message:\n";
...
bool CBlock::AcceptBlock()
{
    ...
    if (!IsProtocolV2(nHeight) && nVersion > 6)
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    string strPubKey = "0389c2a9bc6f946b7f40bb40d32eac77aefb17a007cbdd8f7e68a1af1fc58c076c"; 
