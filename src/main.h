...
static const int64_t DARKSEND_COLLATERAL = (300000*COIN);
static const int64_t DARKSEND_FEE = (0.0001*COIN);
static const int64_t DARKSEND_POOL_MAX = (30000000.99*COIN);
...
inline bool IsProtocolV2(int nHeight) { return nHeight > 0 ? true : false; }
