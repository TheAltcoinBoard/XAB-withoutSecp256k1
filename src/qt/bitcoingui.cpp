...
{
    resize(920, 550);
    setWindowTitle(tr("XAB") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("XAB");
    setStyleSheet("#XAB { background-image:url(:images/bkg);border:none;font-family:'Open Sans,sans-serif'; } #frame { } QToolBar QLabel { padding-top: 0px;padding-bottom: 0px;spacing: 10px;} QToolBar QLabel:item { padding-top: 0px;padding-bottom: 0px;spacing: 10px;} #spacer2 { background:rgb(65,84,101);border:none; } #spacer { background:rgb(0,70,101);border:none; } #toolbar2 { border:none;width:0px;hight:0px;padding-top:0px;padding-bottom:0px; background-color:rgb(51,69,83); } #toolbar { border:1px;height:100%;padding-top:20px; background:#404040; text-align: left; color: white;min-width:100px;max-width:100px;} QToolBar QToolButton:hover {background-color: rgb(84,142,168);} QToolBar QToolButton:checked {background-color: rgb(26,89,117);}"
#ifdef Q_OS_MAC
"QToolBar QToolButton { font-family:Ubuntu;font-size:16px;padding-left:20px;padding-right:55px;padding-top:5px;padding-bottom:5px; width:100%; color: rgb(255,255,255); text-align: left; background-color: rgb(0,70,101);  }"
#else
"QToolBar QToolButton {padding-left:20px;padding-right:70px;padding-top:5px;padding-bottom:5px; width:100%; color: #404040; text-align: left; background-color: #404040;  }"
#endif
"#labelMiningIcon { padding-left:5px;font-family:Century Gothic;width:100%;font-size:10px;text-align:center;color:white; } QMenu { background: #404040; color:white; padding-bottom:10px; } QMenu::item { color:white; background-color: transparent; } QMenu::item:selected { background-color: #c8a46d; } QMenuBar { background-color: #404040; color:white; } QMenuBar::item { font-size:12px;padding-bottom:8px;padding-top:8px;padding-left:15px;padding-right:15px;color:white; background-color: transparent; } QMenuBar::item:selected { background-color: #c8a46d; }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new QAction(QIcon(":/icons/home"), tr("&Dashboard"), this);
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a XAB address"));
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/node"), tr("&Masternodes"), this);
    masternodeManagerAction->setToolTip(tr("Show XAB Nodes status and configure your nodes."));
    ...
    aboutAction = new QAction(tr("&About XAB"), this);
    aboutAction->setToolTip(tr("Show information about XAB"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for XAB"));
...
toolbar->setStyleSheet("QToolButton { color: #ffffff; font-weight:bold;} QToolButton:hover { background-color: #c8a46d } QToolButton:checked { background-color: #a9834f } QToolButton:pressed { background-color: #a9834f } #tabs { color: #ffffff;background-color: #404040;  }");

    QLabel* header = new QLabel();
    header->setMinimumSize(200, 200);
    header->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
    header->setPixmap(QPixmap(":/icons/bitcoin"));
    header->setMaximumSize(200,200);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("XAB client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("XAB client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to XAB network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid XAB address or malformed URI parameters."));
    }
